...
### POST /locations/{locationId}/facility-damages and PUT|PATCH /locations/{locationId}/facility-damages/{facilityDamageId}

Report a new facility damage that occurred at a specific location.

```
{
  "facilityType":   "VEHICLE_SUPPLIES_WINDSHIELD_WIPER_SYSTEM",     // Enum that represents a auxiliary facility that is available at a location: ROOF|FOOD_SERVICE|SEATING|SANITATION|VEHICLE_SUPPLIES_AIR_PRESSURE|VEHICLE_SUPPLIES_WINDSHIELD_WIPER_SYSTEM|VEHICLE_SUPPLIES_VACUUM_CLEANER|GREEN_ROOF|PHOTOVOLTAIC_SYSTEM
  "emergenceDate":  "2023-07-02T20:01:41.448Z",                     // UTC datetime for when the damage emerged.
  "forecastDate":   "2023-07-02T20:01:41.448Z",                     // UTC datetime for when the damage should be repaired [optional].
  "fixDate":        "2023-07-02T20:01:41.448Z"                      // UTC datetime for when the damage was repaired [optional].
}
```

The HTTP response will return an unique damage report identification which was generated by the Leitstelle. It is very bad API design, that the receiver of data chooses an unique identification, because now the sender (and owner) of this data has to store this data along with his own (internal) identifications. It is also very bad API design to use UUIDs for this, as this does not allow to create unique identifications in a distributed way. A simple format like `DE*GEF*REPORT*DAMAGE*5459fd2c-b75e-4a93-8fcb-2dde5d2fc611` would have solved so many problems.

```
{
  "data": {
    "id":              "5459fd2c-b75e-4a93-8fcb-2dde5d2fc611",         // The damage report identification generated by the Leitstelle!
    "locationId":      "5459fd2c-b75e-4a93-8fcb-2dde5d2fc611",
    "facilityType":    "VEHICLE_SUPPLIES_WINDSHIELD_WIPER_SYSTEM",
    "emergenceDate":   "2023-07-02T20:01:41.453Z",
    "forecastDate":    "2023-07-02T20:01:41.453Z",
    "fixDate":         "2023-07-02T20:01:41.453Z"
  },
  "timestamp":       "2022-10-24T12:00:00Z",
  "status_code":      1000,
  "status_message":  "Request was processed successfully"
